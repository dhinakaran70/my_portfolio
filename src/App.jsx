    ...
    return (
        <div className="relative min-h-screen selection:bg-green-tint selection:text-green">
            ...
            <div className="fixed inset-0 z-[-1] bg-navy h-full w-full">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-pink/10 blur-[120px]" />
                <div className="absolute top-[40%] left-[30%] w-[30%] h-[30%] rounded-full bg-green/5 blur-[120px]" />
            </div>
            ...
            {/* Scroll progress & chapter markers */}
            <ScrollProgress />
